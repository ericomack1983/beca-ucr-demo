...
export function Step5WalletIssuance({ students, cardConfig, onStatusChange, onBack }: Props) {
        ...
        <div className="flex gap-3">
          {allDone && (
            <motion.button
              ...
              animate={{ scale: 1, opacity: 1 }}
              className="px-6 py-2.5 bg-slate-900 text-white rounded-xl font-semibold text-sm hover:bg-slate-700 active:scale-95 transition-all flex items-center gap-2"
              onClick={() => {
                const csv = [
