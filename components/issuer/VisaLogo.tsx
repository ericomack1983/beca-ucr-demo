...
export function VisaLogo({ color = '#1434CB', height = 23, className }: VisaLogoProps) {
  ...
  return (
    <svg
      ...
      className={className}
    >
      <path fillRule="evenodd" clipRule="evenodd" d={VISA_PATH} fill={color} />
    </svg>
  );
}
